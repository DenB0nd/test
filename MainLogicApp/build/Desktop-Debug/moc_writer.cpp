...
QT_MOC_LITERAL(4, 24, 12), // "elementAdded"
QT_MOC_LITERAL(5, 37, 5), // "index"
QT_MOC_LITERAL(6, 43, 8), // "finished"
QT_MOC_LITERAL(7, 52, 7) // "process"

    },
    "Writer\0started\0\0message\0elementAdded\0"
    "index\0finished\0process"
};
...
void Writer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->elementAdded((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->finished((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (Writer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Writer::started)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Writer::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Writer::elementAdded)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Writer::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Writer::finished)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Writer::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Writer.data,
    qt_meta_data_Writer,
    qt_static_metacall,
    nullptr,
    nullptr
